...
class MarketRepository:
    ...
    def _yahooquery_quote(self, ticker_symbol: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "day_open": self._sanitize_val(price_data.get("regularMarketOpen") or detail.get("regularMarketOpen") or detail.get("open")),
